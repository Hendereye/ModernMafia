...
<br>
<?if($crewbossi > '0'){echo"<center><form action='admincewforum.php?crewid=$crewid' method=post><input type=submit name=clear value='Delete topics' class=textbox></form></center>";}?>
...
$selectupdatesql = mysql_query("SELECT * FROM forumtopics WHERE type = '$crewid' AND id = '4' ORDER BY time DESC LIMIT 0,50");

while($selectupdate = mysql_fetch_array($selectupdatesql))
{
$utitle = html_entity_decode($selectupdate['title'], ENT_NOQUOTES);
$utopicid = $selectupdate['topicid'];
$ulocked = $selectupdate['locked'];
$ucreator = $selectupdate['creator'];
$uforumrank = $selectupdate['rankid'];
...
$utitle = str_replace($zpattern,$zreplace,$utitle);
...
$greplace[2] = "<u>$1</u>";
$greplace[3] = "<i>$1</i>";
$greplace[5] = "<font color=\"$1\">$2</font>";
$greplace[13] = "<s>$1</s>";

$utitlea = preg_replace($gpattern,$greplace,$utitle);
...
$utitle = str_replace($fpattern,$freplace,$utitlea);
}


echo("<tr><td bgcolor=#333333 width=100%><a href=admincrewviewtopic.php?topicid=$itopicid&crewid=$crewid STYLE=FONT-FAMILY:tahoma;>&nbsp;<b>IMPORTANT:</b><font color=silver size=1 face=verdana>&nbsp;$ititle</font></a>");
...
$creplace[2] = "<u>$1</u>";
$creplace[3] = "<i>$1</i>";
$creplace[5] = "<font color=\"$1\">$2</font>";
$creplace[13] = "<s>$1</s>";
...
echo("<tr><td bgcolor=#333333 width=100%><a href=admincrewviewtopic.php?topicid=$stopicid&crewid=$crewid STYLE=FONT-FAMILY:tahoma;>&nbsp;<b>STICKY:</b><font color=silver  size=1 face=verdana>&nbsp;$stitle</font></a>");
if($slocked == 'yes'){echo'<font color=gray size=1 face=verdana>&nbsp;(Locked)</font>';}
...
echo("<tr><td bgcolor=#333333 width=100%><a href=admincrewviewtopic.php?topicid=$topicid&crewid=$crewid><font color=silver size=1 face=verdana>&nbsp;$title</font></a>");
...
<br><center><br><font color="white" face="verdana" size="1">Create topic</font><br><form action="admincewforum.php?crewid=<?echo$crewid;?>" method="post" name="smiley"><input type="text" class="textbox" name="newtopic"><br><font color="white" face="verdana" size="1">Topic content</font><br><textarea name="newtopicinfo" cols="42" rows="11" class="textbox" id ="topicinfo">
