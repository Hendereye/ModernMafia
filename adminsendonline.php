...
echo"<font color=\"white\" face=\"verdana\" size=\"1\"><b>Message sent to all</b>!</font>";mysql_query("UPDATE users SET mail = (mail + 1) WHERE status = 'Alive'");}
...
<td height="22" background="/more/top.png" NOWRAP><font color="white" face="verdana" size="1"><center><b>Send to all online</b></center></font></td>
