...
elseif($erows > '1'){echo"<font color=white face=verdana size=1>User is already a Moderator!</font>";}
else{
mysql_query("UPDATE users SET rankid ='50' WHERE username = '$name'");
mysql_query("DELETE FROM jail WHERE username = '$name'");
echo"<font color=white face=verdana size=1>User <b>$name</b> is now a Moderator! <b>YOU</b> now take responsibility for their actions!</font>";}}

?> 
<table align="center" width="100%" cellpadding="0" cellspacing="0">
<tr>
<td width="8" height="22" background="/more/topleft.png"></td>
<td height="22" background="/more/top.png" NOWRAP><font color="#222222" face="verdana" size="1"><b><center>Promote Moderator</b></center></font></td>
