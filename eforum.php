...
VALUES ('$gangsterusername','1','$time','e','$forumtopic','$forumtopicinfo','$userrank')");
...
<td height="22" background="/more/top.png" NOWRAP><font color="#222222" face="verdana" size="1"><center><b>Entertainment Forum</b></center></font></td>
...
echo("<tr><td class=wtf  width=100%><a href=eviewtopic.php?topicid=$itopicid><font color=999999>&nbsp;<b>IMPORTANT:</b>&nbsp;$ititle</font>");
...
echo("<tr><td class=wtf width=100%><a href=eviewtopic.php?topicid=$stopicid><font color=999999>&nbsp;<b>STICKY:</b>&nbsp;$stitle</font>");
...
echo("<tr><td class=$cls width=100%><a href=eviewtopic.php?topicid=$topicid><font color=999999>&nbsp;$title</font>");
...
<? if(($etest < '1')&&($userrank < '25')){ } else{?>
<br><form method="post" name="smiley"><center><font color="white" face="verdana" size="1">Create topic</font><br><input type="text" class="textbox" name="newtopic"><br><font color="white" face="verdana" size="1">Topic content</font><br><textarea name="newtopicinfo" cols="42" rows="11" class="textbox" id ="topicinfo">
