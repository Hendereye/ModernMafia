...
elseif($erows == '0'){echo"<font color=white face=verdana size=1>User is not an entertainer!</font>";}
else{
mysql_query("DELETE FROM entertainers WHERE username = '$name'");
echo"<font color=white face=verdana size=1>User <b>$name</b> is no longer a entertainer!</font>";
...
<td height="22" background="/more/top.png" NOWRAP><font color="#222222" face="verdana" size="1"><b><center>Demote entertainer</b></center></font></td>
