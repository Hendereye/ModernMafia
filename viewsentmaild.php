...
<?php
$getposts = mysql_query("SELECT * FROM messages WHERE sentfrom = '$getname' AND d = '1' ORDER BY id DESC LIMIT $selectfrom,$selectto ");
...
?>
<table align=center width=100% cellpadding=0 cellspacing=0><tr><td width=8 height=22 background=/more/topleft.png></td><td height=22 background=/more/top.png NOWRAP><font color=white face=verdana size=1><b>Message sent to</b>: </font><a href=viewprofile.php?username=<? echo $postname?>><? echo $color; ?></td><td width=8 height=22 background=/more/topright.png></td></tr><tr><td width=8 background=/more/leftb.png NOWRAP></td><td background=/more/crossbg.png><font color=white face=verdana size=1>
