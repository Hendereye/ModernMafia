...
<body background="/more/bgtest.png" onload="setTimeout('mrnewtits()',500);">
...
VALUES ('$gangsterusername','1','$time','d','$forumtopic','$forumtopicinfo','$rank')");
...
echo("<tr><td class=wtf  width=100%><a href=dviewtopic.php?topicid=$itopicid><font color=#cccccc>&nbsp;<b>IMPORTANT:</b>&nbsp;$ititle</font>");
...
echo("<tr><td class=wtf width=100%><a href=dviewtopic.php?topicid=$stopicid><font color=#cccccc>&nbsp;<b>STICKY:</b>&nbsp;$stitle</font>");
...
echo("<tr><td class=$cls width=100%><a href=dviewtopic.php?topicid=$topicid><font color=#cccccc>&nbsp;$title</font>");
if($locked == 'yes'){echo'<font color=gray size=1 face=verdana>&nbsp;(Locked)</font>';}
echo("</a></td><td class=wtfs align=right><a href=viewprofile.php?username=$creator><font color=#cccccc size=1 face=verdana>$creator&nbsp;</font></a></td><td class=wtfs align=right><span id=aww$topicid><font color=#cccccc size=1 face=verdana>$topicpost</font></span></td></tr>");
}
?>
