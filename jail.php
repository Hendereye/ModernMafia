...
<td height="22" background="/more/top.png" NOWRAP><font color="#222222" face="verdana" size="1"><center><b>Jail</b> <?if($ffs == 1){echo' / </font><font color=yellow face=verdana size=1>You are in Jail!';}?></font></center></td>
...
<tr><td align=center valign=middle width=65% bgcolor=444444 NOWRAP align=center><center><font color=white face=verdana size=1>Prisoner:</font></center></td><td width=20% bgcolor=444444 valign=middle align=center><center><font color=white face=verdana size=1>Time Left:</font></center><td width=20%  bgcolor=444444  valign=middle align=center><center><font color=white face=verdana size=1>Bust Reward:</font></center></td></tr>
...
echo"<tr><td width=55%  class=wtf NOWRAP><input type=radio value=$jailid name='$bustbutton'><a href=viewprofile.php?username=$jailname><font color=white face=verdana size=1>$jailname</font></a></td>
<td width=15%  class=wtfs NOWRAP><font color=white face=verdana size=1>$jailtimea seconds</font></td><td width=30%  class=wtfs NOWRAP><font color=white face=verdana size=1>$$jailrewarda</font></td></tr>";}}
else{echo"<tr><td width=100% class=wtfs NOWRAP colspan=3 align=center><center><br><font color=white face=verdana size=1>There is currently no players in jail</font><br><br></center></td></tr>";}?>
</table>
...
<br><Table width=55%>
<tr><td bgcolor=#222222 NOWRAP><font color=white face=verdana size=2> | </font><font color=silver face=verdana size=1>Busting Success Rate: </font><font color=silver face=verdana size=1><?echo$total;?>%</font><font color=white face=verdana size=2> | </font><font color=silver face=verdana size=1>Most Busts Without Failure: </font><font color=silver face=verdana size=1><?echo$joint;?></font><font color=white face=verdana size=2> | </font><font color=silver face=verdana size=1>Current Busts Without Failure: </font><font color=silver face=verdana size=1><?echo$now;?></font><font color=white face=verdana size=2> | </font></td></tr></table>
<br><center>
<? $mtr = mt_rand(0,50000000);  if($jailrand == '1'){echo"<font color=white face=verdana size=1>Code:</font><input type=textbox name=ver class=textbox><img src=vercode1.php?id=$ID&hi=$mtr><br>";}?><input type=submit name=dobust value="Bust out!" class="textbox"></center></form></center><br><center><form action="jail.php" method="post"><font color=white face=verdana size=1>Give reward for the person that busts you out:</font><br><input type=text class=textbox name=reward value="<? echo"$$getrewarda";?>"><input type=submit value="Set reward" class=textbox>
<?if(($rankid >= '25')||($senior > '0')){echo"<br><input type=submit name=deleteall value='Delete Posts' class=textbox>";}?></center><br>
...
elseif($rankcolor == '50'){$color = "<font color=2554C7 face=verdana size=1><b>$postname</b></font>";} 
