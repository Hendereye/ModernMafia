...
VALUES ('$gangsterusername','1','$time','main','$forumtopic','$forumtopicinfo','$rank','1')");
...
?>
<div id=boxy style=display:none;><table align="center" width="100%" cellpadding="0" cellspacing="0">
<tr>
<td width="8" height="22" background="/more/topleft.png"></td>
<td height="22" background="/more/top.png" NOWRAP><center><font color="#222222" face="verdana" size="1"><b>Main Forum</b></font></td>
<td width="8" height="22" background="/more/topright.png"></td>
</tr>

<tr>
<td width="8" background="/more/leftb.png" NOWRAP></td>
<td background="/more/crossbg.png"><div id=box></div></td>
...
<tr>
<td width="8" height="22" background="/more/topleft.png"></td>
<td height="22" background="/more/top.png" NOWRAP><center><font color="#222222" face="verdana" size="1"><b>Forum</b></font></center></font></font></td>
<td width="8" height="22" background="/more/topright.png"></td>
</tr>
...
$selectstickysql = mysql_query("SELECT * FROM forumtopics WHERE esc = '1' AND id = '2' AND topicid != '5481' ORDER BY time DESC");

$selectimportantsql = mysql_query("SELECT * FROM forumtopics WHERE esc = '1' AND id = '3' ORDER BY time DESC");

$selectdjsql = mysql_query("SELECT * FROM forumtopics WHERE esc = '1' AND id = '4' AND topicid != '5481' ORDER BY time DESC");
...
echo("<tr><td class=wtf  width=100%><a href=viewtopic.php?topicid=$itopicid><font color=#cccccc>&nbsp;<b>IMPORTANT:</b>&nbsp;$ititle</font>");
if($ilocked == 'yes'){echo'<font color=gray size=1 face=verdana>&nbsp;(Locked)</font>';}
echo("</a></div></td><td class=wtfs align=right><a href=viewprofile.php?username=$icreator><font color=#cccccc size=1 face=verdana>&nbsp;$icreator&nbsp;</font></a></td><td class=wtfs align=right><span id=aww$itopicid><font color=#cccccc size=1 face=verdana>$itopicpost</font></span></td></tr>");
}?>
<tr><td colspan=3 class=TS height=1></td></tr>
<?
...
echo("<tr><td class=wtf width=100%><a href=viewtopic.php?topicid=$stopicid><font color=#cccccc>&nbsp;<b>STICKY:</b>&nbsp;$stitle</font>");
if($slocked == 'yes'){echo'<font color=gray size=1 face=verdana>&nbsp;(Locked)</font>';}
echo("</a></td><td class=wtfs align=right><a href=viewprofile.php?username=$screator><font color=#cccccc size=1 face=verdana>&nbsp;$screator&nbsp;</font></a></td><td class=wtfs align=right><span id=aww$stopicid><font color=#cccccc size=1 face=verdana>$stopicpost</font></span></td></tr>");
}?>
...
$stopicpost = $selectdj['posts'];

?>

<?

echo("<tr><td class=wtf width=100%><a href=viewtopic.php?topicid=$stopicid><font color=#cccccc>&nbsp;$stitle</font>");
if($slocked == 'yes'){echo'<font color=gray size=1 face=verdana>&nbsp;(Locked)</font>';}
echo("</a></td><td class=wtfs align=right><a href=viewprofile.php?username=$screator><font color=#cccccc size=1 face=verdana>&nbsp;$screator&nbsp;</font></a></td><td class=wtfs align=right><span id=aww$stopicid><font color=#cccccc size=1 face=verdana>$stopicpost</font></span></td></tr>");
}?>
...
echo("<tr><td class=$cls width=100%><a href=viewtopic.php?topicid=$topicid><font color=#bbbbbb>&nbsp;$title</font>");
if($locked == 'yes'){echo'<font color=gray size=1 face=verdana>&nbsp;(Locked)</font>';}
echo("</a></td><td class=wtfs align=right><a href=viewprofile.php?username=$creator><font color=#bbbbbb size=1 face=verdana>&nbsp;$creator&nbsp;</font></a></td><td class=wtfs align=right><span id=aww$topicid><font color=#cccccc size=1 face=verdana>$topicpost</font></span></td></tr>");
}
?>
