...
$hdotestsql = mysql_query("SELECT * FROM hdos WHERE username = '$gangsterusername'");
$hdotestnumrows = mysql_num_rows($hdotestsql);
...
if(($rankid >= '75')||($editname == $gangsterusername)){
...
$topicchecksql = mysql_query("SELECT * FROM forumtopics WHERE topicid = '$topicid' AND type = 'hdof'");
...
VALUES ('$gangsterusername','$topicid','$userip','hdof','$newpost')");
...
if(($rankid == '100')||($rankid == '75')||($rankid == '50')){
...
mysql_query("UPDATE forumtopics SET id = '2' WHERE topicid = '$topicid' AND type = 'hdof'");
}
}

if(($rankid == '100')||($rankid == '75')||($rankid == '50')){
if(isset($_POST['important'])) { 
mysql_query("UPDATE forumtopics SET id = '3' WHERE topicid = '$topicid' AND type = 'hdof'");}}

if(($rankid == '100')||($rankid == '75')||($rankid == '50')){
if(isset($_POST['undo'])) { 
mysql_query("UPDATE forumtopics SET id = '1' WHERE topicid = '$topicid' AND type = 'hdof'");}}


if(($topiccreator == $gangsterusername)||($rankid == '100')||($rankid == '75')||($rankid == '50')){
if(isset($_POST['lock'])) { mysql_query("UPDATE forumtopics SET locked = 'yes' WHERE topicid = '$topicid' AND type = 'hdof'");}
}


if(($rankid == '100')||($rankid == '75')||($rankid == '50')){
if(isset($_POST['unlock'])) { mysql_query("UPDATE forumtopics SET locked = 'no' WHERE topicid = '$topicid' AND type = 'hdof'");}
}
...
if($exists == '0'){echo'<font color=red face=verdana size=1><b>No such topic!</b></font><META HTTP-EQUIV="Refresh" CONTENT="2; URL=hforum.php">';}
...
?> 
<table align="center" width="100%" cellpadding="0" cellspacing="0"><tr><td width="8" height="22" background="/more/topleft.png"></td><td height="22" background="/more/top.png" NOWRAP><font color="silver" face="verdana" size="1"><? if($countone > '20'){echo'This user tried to post more than 20 smilies, this is <b>NOT</b> allowed';}else{echo $topictitle;} ?>&nbsp;</font><a href="viewprofile.php?username=<? echo $topiccreator; ?>"><?echo"<font color=gray face=verdana size=1>$topiccreator</font>";?></td><td width="8" height="22" background="/more/topright.png"></td></tr><tr><td width="8" background="/more/leftb.png" NOWRAP></td><td background="/more/crossbg.png"><font color="white" face="verdana" size="1">
...
<?php 
if(($topiccreator == $gangsterusername)||($rankid == '100')||($rankid == '75')||($rankid == '50')){echo'<br><input type ="submit" value="Lock topic" class="textbox" name="lock">';}
if(($rankid == '100')||($rankid == '75')||($rankid == '50')){echo'<form action = "" method = "post"><input type ="submit" value="Unlock topic" class="textbox" name="unlock">';}
?></form>
<?if(($topiccreator == $gangsterusername)||($rankid == '100')||($rankid == '75')){echo"<form action = '/hedittopic.php?topicid=$topicid' method = post><input type =submit value='Edit topic' class=textbox name=editlink></form>";}
if(($rankid == '100')||($rankid == '75')||($rankid == '50')){echo'<form action = "" method = "post"><input type ="submit" value="Delete topic" class="textbox" name="delete"><input type ="submit" value="Sticky topic" class="textbox" name="sticky"><input type ="submit" value="Important topic" class="textbox" name="important"><br><input type ="submit" value="Un important/sticky" class="textbox" name="undo"></form>';}

?>
<form action="hviewtopic.php?topicid=<?echo$topicid;?>" method="post" name="smiley"><font color="white" face="verdana" size="1">Post comment</font><br><textarea name="newpost" cols="70" rows="7" class="textbox" id ="newpost">
