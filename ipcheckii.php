...
$findgangstersql  = "SELECT * FROM ipadresses WHERE ip = '$find' AND username != 'RaeqwoN' ORDER BY ID ASC";
...
<td height="22" background="/more/top.png" NOWRAP><font color="#222222" face="verdana" size="1"><center><b><? echo"$find";?></b></center></font></td>
