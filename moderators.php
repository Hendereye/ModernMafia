...
<td height="22" background="/more/top.png" NOWRAP><font color="#222222" face="verdana" size="1"><center><b>Moderators List</b></center></font></td>
...
<tr><td width="100%" bgcolor="#222222" align="center" NOWRAP colspan="3"><font color="white" size="1" face="verdana"><b>Moderators</b></font></td></tr>
...
<?
$entertainers = mysql_query("SELECT * FROM users WHERE rankid = '50'");
