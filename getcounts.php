...
$editsql = mysql_query("SELECT * FROM forumtopics WHERE topicid = '$tits' AND type = 'd'");
...
if($topicid != $posttits){echo"<table width=100%><tr><td bgcolor=444444 height=35 align=center valign=middle style='border: silver 1px solid;-moz-border-radius-topleft:25px;-moz-border-radius-bottomright:25px;'><a href=dviewtopic.php?topicid=$tits><b><u><font color=khaki face=verdana size=1>$news new posts,</font><font color=white face=verdana size=1> click to view</u>!</font></b></a></td></tr></table>";}}
?>